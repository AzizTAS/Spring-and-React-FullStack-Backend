...
public class StaticResourceConfiguration implements WebMvcConfigurer {
    ...
    public StaticResourceConfiguration(HoaxifyProperties hoaxifyProperties) {
    ...
    CommandLineRunner createStorageDirs() {
        return args -> {
            ...
            createFolder(
                    Paths.get(hoaxifyProperties.getStorage().getRoot(), hoaxifyProperties.getStorage().getProfile()));
        };
    }
